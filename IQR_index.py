...
for target_file in files:
    if target_file.endswith('_all_xcalibrated_clean.vot'):  # Check for specific file 
        ...
        new_table = Table(data=[ra_column, dec_column, N, iqr], names=('RA', 'DEC', 'N', 'interquartile_range'))
        ...
        output_file_path = os.path.join(output_folder, f"{base_name}_iqr_index.vot")

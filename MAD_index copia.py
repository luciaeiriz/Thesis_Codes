...
for target_file in files:
    if target_file.endswith('.vot'):  # Check for specific file 
        ...
        new_table = Table(data=[ra_column, dec_column, N, mad, mean_magnitude], names=('RA', 'DEC', 'N', 'median_absolute_deviation', 'mean_magnitude'))
        ...
        output_file_path = os.path.join(output_folder, f"{base_name}_mad.vot")

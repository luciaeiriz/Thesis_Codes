...
index_column = "Stetson_K"  # Change when necessary
...
for i, (var_file, nonvar_file) in enumerate(file_pairs):
    ...
    axes[i].set_xlabel("Stetson K", fontsize = 10) # Change when necessary
...
#     axes[i].set_xscale('log')
#     axes[i].set_title(f"{title}\nKS p-value: {p_value:.3e}", fontsize = 10)
#     axes[i].set_xlabel("Welch Stetson", fontsize = 10) # Change when necessary
#     axes[i].set_ylabel("Cumulative Probability", fontsize = 10)
#     axes[i].grid(True)
